...
fs.readFile(packagePath, "utf8", (err, data) => {
  ...
  try {
    ...
    let versionParts = packageJson.versionsandbox
      .split(".")
    ...
    packageJson.versionsandbox = versionParts.join(".");
    ...
    fs.writeFile(
      ...
      (err) => {
        ...
        console.error("Version number updated to:", packageJson.versionsandbox);
      }
    );
  } catch (err) {
